...
<div class="container-vue">
  <h1 class="text">5 Day / 3 Hour Forecast Weather<h2>Pk's Forecast🌦️</h2></h1> 
...
@media only screen and (max-width: 750px) {
  ...
  .text{
    ...
    text-align: center;
    font-weight: 600;
    box-shadow: 20px 10px 2px rgba(1, 0, 0, 0);
...
.card {
  ...
  box-shadow: 1px 155px 62px rgba(0, 0, 0, 0.01), 0px 87px 52px rgba(0, 0, 0, 0.05), 0px 39px 39px rgba(0, 0, 0, 0.09), 0px 10px 21px rgba(0, 0, 0, 0.1), 0px 0px 0px rgba(0, 0, 0, 0.1);
  border-radius: 25px;
